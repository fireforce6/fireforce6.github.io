  ...
  return ({ displayClass }: QuartzComponentProps) => {
    ...
    return (
      <footer class={`${displayClass ?? ""}`}>
        <p>© {year} <a href="https://www.modelware.io/">Modelware</a>. All Rights Reserved.</p>
...
export const sharedPageComponents: SharedLayout = {
  ...
  footer: MyFooter({
    links: {
      ...
      "Slack": "https://join.slack.com/t/fireforcevi-f25/shared_invite/zt-3ewvs3tk4-o8BoI1PSoU5UhBAnep~Vlg",
    },
  }),
}
